...
const floatingPills = [
  { label: "Pa Historik Pacienti", gradient: "from-pink-400 to-rose-500", startX: -120, startY: -100, rotate: -6 },
  { label: "Faturim Manual", gradient: "from-emerald-400 to-green-500", startX: 80, startY: -80, rotate: 3 },
  { label: "Pa Kujdes pas Vizitës", gradient: "from-violet-400 to-blue-500", startX: -140, startY: 40, rotate: -3 },
  { label: "Staf i Çorganizuar", gradient: "from-orange-400 to-amber-500", startX: 100, startY: 60, rotate: 6 },
...
const PainPointSection = () => {
  const bullets = [
    { icon: Circle, title: "Të dhëna të shpërndara", desc: "Dosjet e pacientëve humbasin ose gjenden me vështirësi. DenteOS i centralizon të gjitha në një vend." },
    { icon: CheckCircle2, title: "Faturim Manual", desc: "Faturimi kërkon shumë kohë. DenteOS gjeneron fatura menjëherë me një klik." },
    { icon: Star, title: "Konfuzion i Stafit", desc: "Stafi nuk di kush bën çfarë. DenteOS organizon rolet dhe detyrat qartë." },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-14 items-center">
            ...
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold leading-tight tracking-tight text-foreground font-heading">
                Klinika Juaj Duhet të Funksionojë
                <br />
                Qetë, Jo Kaotike
              </h2>
